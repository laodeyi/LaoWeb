  ...
  <div id="merchant-login">
    <b-form id="merchant-login-form">
      ...
      <b-form-group id="merchant-button-group">
        <b-button v-if="log_type === 'login'" variant="outline-dark" @click="merchant_login"
          >Login</b-button
        >
        <b-button v-else="log_type === 'register'" variant="outline-dark" @click="merchant_register"
          >Register</b-button
        >
      </b-form-group>
    </b-form>

  ...
  <div id="merchant-stat">
    ...
    <div id="merchant-right-main">
      <div id="info-stat">
        ...
        <p>
          <label style="display: block;margin: 0">Favourite Members : </label>
          <b v-for="member of mostUsuallyMembers">
            |
    ...
    modify_discount() {
      utils.axiosMethod({
        ...
        callback: response => {
          ...
          if (response.data.code === 1) this.get_discount();
        }
      });
    },
    get_deals(i) {

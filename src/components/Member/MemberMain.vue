    ...
    <div id="member-left-nav">
      <b-list-group v-b-scrollspy.member-right-main>
        <b-list-group-item
          ...
          disabled="disabled"
          >{{ merchantType[i].name }}</b-list-group-item
        >
      </b-list-group>
    </div>
        ...
        <div class="merchant-div" v-for="merchant of get_type_merchants(i)">
          ...
          <div class="merchant-info">
            ...
            <span class="address-span">
              ...
              <strong>Y:</strong> {{ merchant.address.latitude }} <strong>Address: </strong
              ><small> {{ merchant.address.note }}</small>
            </span>
  ...
  methods: {
    get_merchants() {
      utils.axiosMethod({
        ...
        callback: response => {
          if (response.data.code === 1) this.merchants = response.data.list;
